...
<div class="container-fluid">
    ...
    <center>
        <table class="kop">
            <td style="font-size: 30px; font-weight: bold;">Laporan Data Antrian</td>
        </table>
    </center>
    ...
    <div class="ttd" style="display: inline-block;">
        ...
        <br>
        <br>
        <h4 style="margin-bottom: 1px;">Nita Qorbaniati AMD. KES</h4>
        <hr size="2px" color="black" style="margin-top: 1px;">
        <h4 style="margin-top: 1px;">NIP.199206152019032009</h4>
    </div>
