...
<div class="container-fluid">
    ...
    <center>
        <table class="kop">
            <td style="font-size: 30px; font-weight: bold;">Laporan Rekapitulasi Pasien Terjadwal Pemeriksaan Karang Gigi</td>
        </table>
    </center>
    ...
    <div class="ttd" style="display: inline-block;">
        ...
        <br>
        <br>
        <h4 style="margin-bottom: 1px;">drg. Cynthia Soenarjo</h4>
        <hr size="2px" color="black" style="margin-top: 1px;">
        <h4 style="margin-top: 1px;">NIP.198102102008012021</h4>
    </div>
