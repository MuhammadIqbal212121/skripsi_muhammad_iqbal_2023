                ...
                <div class="col-12">
                   ...
                   INNER JOIN pasien ON jadwal_gigi.id_pasien = pasien.id_pasien");
                    if (isset($_POST['submit'])) {
                        ...
                        $query = mysqli_query($koneksi, "SELECT * FROM jadwal_gigi
                        INNER JOIN pasien ON jadwal_gigi.id_pasien = pasien.id_pasien
                        WHERE YEAR(jadwal_gigi.tgl_jadwal) = '$tahun' AND MONTH(jadwal_gigi.tgl_jadwal) = '$bulan'");
                    ?>
                        <div class="callout callout-info">
                            <h5><i class="fas fa-info"></i> *:</h5>
                            Halaman Ini Telah Di Optimalkan Untuk Pencetakan. Silakan Click tombol print.
                            <a href="../print/print_jadwal_gigi.php?bulan=<?= $bulan ?>&&tahun=<?= $tahun ?>" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                        </div>
                    <?php
                     }else {
                        ?>
                            <div class="callout callout-info">
                                <h5><i class="fas fa-info"></i> *:</h5>
                                Halaman Ini Telah Di Optimalkan Untuk Pencetakan. Silakan Click tombol print.
                                <a href="../print/print_jadwal_gigi.php" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                            </div>
                        <?php
                        }
                        ?>
