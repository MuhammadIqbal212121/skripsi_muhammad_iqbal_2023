        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <?php
                    $query = mysqli_query($koneksi, "SELECT * FROM poli_mtbs 
                    INNER JOIN antrian ON poli_mtbs.id_antrian = antrian.id_antrian
          ...
          WHERE MONTH(antrian.tgl_antrian) = '$bulan' AND YEAR(antrian.tgl_antrian) = '$tahun'");
                    ?>
                        <div class="callout callout-info">
                            ...
                            <a href="../print/print_poli_mtbs.php?tahun=<?= $tahun ?>&&bulan=<?= $bulan ?>" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                        </div>
                        <?php
                    }else {
                        ?>
                            <div class="callout callout-info">
                                <h5><i class="fas fa-info"></i> *:</h5>
                                Halaman Ini Telah Di Optimalkan Untuk Pencetakan. Silakan Click tombol print.
                                <a href="../print/print_poli_mtbs.php" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                            </div>
                        <?php
                        }
                        ?>
